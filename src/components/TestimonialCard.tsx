...
function TestimonialCard({ name, job, comment, img }: TestimonialCardType) {
  return (
    <div className="max-w-xs sm:max-w-sm md:max-w-md mx-auto p-4 sm:p-6 bg-backgroundGray rounded-xl shadow-xl">
      <MdFormatQuote size={40} className="text-darkGray my-4" />
      <p className="text-base sm:text-lg text-darkGray mb-4 sm:mb-6">
        {comment}
      </p>
